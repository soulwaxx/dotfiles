...
- **Exploring alternative interfaces:** see [DESIGN-IT-TWICE.md](DESIGN-IT-TWICE.md). Draft several materially different interfaces, then compare depth, locality, and seam placement.
