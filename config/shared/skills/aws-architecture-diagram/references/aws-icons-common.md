...
If a service is NOT found in any `aws-icons-*.md` reference file, do not guess a stencil name and never render it as a plain colored rectangle. Use the generic AWS cloud icon with the service name as the label:
```
