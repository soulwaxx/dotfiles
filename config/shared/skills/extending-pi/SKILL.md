...
> Vendored from [tmustier/pi-extensions](https://github.com/tmustier/pi-extensions) (`extending-pi/`, MIT license, see `LICENSE`). No longer pulled in as a live package — copied in statically so the skill stays available without cloning the whole upstream repo.
...
- "Pi should change the footer, add plan mode, or alter compaction" → **Extension**
